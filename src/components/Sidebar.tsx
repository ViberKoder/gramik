  ...
  return (
    <aside className="w-[72px] xl:w-[275px] flex flex-col items-center xl:items-stretch border-r border-x-border bg-white min-h-screen sticky top-0">
      ...
      <nav className="flex-1 flex flex-col gap-1 mt-2 w-full px-2">
        ...
        <button type="button" className="xl:w-full mt-2 mx-2 xl:mx-0 px-4 py-3 min-h-[52px] rounded-full bg-ton hover:bg-ton-hover text-white font-bold text-base transition-colors shadow-sm cursor-pointer">
